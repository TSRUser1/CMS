...
(
	...
	FROM	sys.objects 
	WHERE	type = 'P' 
			AND	name = 'SP_I_InsertLeagueForTeam' 
			AND schema_name(schema_id) = 'dbo'
)
BEGIN
	DROP  PROCEDURE  SP_I_InsertLeagueForTeam
END
GO

/*************************************************************************
* Name				: SP_I_InsertLeagueForTeam
* Author			: Ramani Ganason
* Create date		: 30-Aug-2015
* Description		: Insert League Details for Event
*************************************************************************/
CREATE PROCEDURE [SP_I_InsertLeagueForTeam]
(
	@n_TeamID					int,
	@n_EventID					int,
...
GO
/*
GRANT EXEC ON [dbo].[SP_I_InsertLeagueForTeam] TO USER
GO*/