<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="SEM.CMS.Result.Mobile.Error" MasterPageFile="RWeb.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderRWeb" runat="server">
    ...
    <div style="line-height:1.6;font-weight:300;text-align:justify;padding-bottom:50px">
        ...
        <p>
            <span style="font-size: 18px">Click <a href="Default.aspx">here</a> to go back to homepage.
            </span>
        </p>
    </div>
</asp:Content>
