<%@ Page Title="" Language="C#" MasterPageFile="~/RWeb.Master" AutoEventWireup="true" CodeBehind="MultiMedallist.aspx.cs" Inherits="SEM.CMS.Result.Mobile.Medal.MultiMedallist" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderRWeb" runat="server">
    <div class="row">
        <div class="col-md-12 iconDiv">
            <h1><asp:Label ID="lblMedallist" runat="server" Text="Medallists" style="vertical-align:top;" CssClass="hidden"></asp:Label>
                    <asp:ImageButton ID="btnOverall" CssClass="ImageIcon" ImageUrl="/Images/Standing.png" runat="server" OnClientClick="return Navigate(this);" Text="Overall Medal Standings" data-navigate-url="/Medal/Standing.aspx" />
                    <asp:ImageButton ID="btnMedalBySports" CssClass="ImageIcon" ImageUrl="/Images/singlemedal.png" runat="server" OnClientClick="return Navigate(this);" Text="Medal By Sports" data-navigate-url="/Medal/Country.aspx" />
                    <asp:ImageButton ID="btnDailyMedallist" CssClass="ImageIcon" ImageUrl="/Images/multimedal.png" runat="server" OnClientClick="return Navigate(this);" Text="Daily Medallists" />
            </h1>
        </div>
    </div>
    <div class="row">
