<%@ Page Title="" Language="C#" MasterPageFile="~/RWeb.Master" AutoEventWireup="true" CodeBehind="Country.aspx.cs" Inherits="SEM.CMS.Result.Web.Medal.Country" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderRWeb" runat="server">
    <div class="row">
        <div class="col-md-12">
            <h1>
                <asp:Label id="lblHeader" runat="server" style="vertical-align:top;"></asp:Label>
                &nbsp;
