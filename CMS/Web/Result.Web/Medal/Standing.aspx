<%@ Page Title="" Language="C#" MasterPageFile="~/RWeb.Master" AutoEventWireup="true" CodeBehind="Standing.aspx.cs" Inherits="SEM.CMS.Result.Web.Medal.Standing" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderRWeb" runat="server">        
    <div class="row">
        <div class="col-md-12">
            <h1><asp:Label id="lblHeader" runat="server" style="vertical-align:top;"></asp:Label>
                    ...
                    <asp:Button ID="btnMultiMedallist" runat="server" OnClientClick="return Navigate(this);" Text="Multi-Medallists" CssClass="btn btn-default btn-medal-standings" data-navigate-url="/Medal/MultiMedallist.aspx?IsMulti=true" />
            </h1>
        </div>
    </div>
                    ...
                    <asp:GridView ID="dgMedalStanding" runat="server" EnableViewState="true" CssClass="table table-striped" ShowHeaderWhenEmpty="true" EmptyDataText="No records found." EmptyDataRowStyle-HorizontalAlign="Center"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Rank">
                                <ItemTemplate>
                                    <%# ViewState[SEM.CMS.Result.Web.WebBase.VS_MEDALSTANDINGS_TOTAL] == null ? "" : ( Convert.ToInt32(ViewState[SEM.CMS.Result.Web.WebBase.VS_MEDALSTANDINGS_TOTAL]) == 0 ? "" : Eval("Rank")) %>
                                </ItemTemplate>
                            </asp:TemplateField>
