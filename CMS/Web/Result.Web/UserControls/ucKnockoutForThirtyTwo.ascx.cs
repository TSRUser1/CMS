...
{
    public partial class ucKnockoutForThirtyTwo : System.Web.UI.UserControl
    {
        ...
        {            
            if (competitionDS.KnockoutSummary.Count > 0)
            {
                ...
                if (roundNameTable.Rows.Count > 2)
                {
                    lblRoundName3.Text = roundNameTable.Rows[2]["RoundName"].ToString();
                }

                if (roundNameTable.Rows.Count > 3)
                {
                    lblRoundName4.Text = roundNameTable.Rows[3]["RoundName"].ToString();
                }

                if (roundNameTable.Rows.Count > 4)
                {
                    lblRoundName5.Text = roundNameTable.Rows[4]["RoundName"].ToString();
                }

                if (roundNameTable.Rows.Count > 5)
                {
                    lblRoundName6.Text = roundNameTable.Rows[5]["RoundName"].ToString();
                    isThridPlacing = true;
                }
