    ...
    public partial class InsertResult : System.Web.UI.Page
    {
        ...
        public void ProcessRequest()
        {
            ...
            try
            {
                ...
                int scheduleID = Convert.ToInt32(context.Request[REQUEST_PARAMETER_ScheduleID]);
                int teamOrParticipantID = Convert.ToInt32(context.Request[REQUEST_PARAMETER_TeamID]);
                ...
                if (query.Length > 0)
                {
                	scoreRow.ScheduleID = scheduleID;
                ...
                scheduleRow.ScheduleID = Convert.ToInt32(context.Request[REQUEST_PARAMETER_ScheduleID]);
                ...
                if (IsTeamGame)
                {
                    requestDS.Score[0].TeamID = teamOrParticipantID;
                    responseDS = competitionSVC.InsertScoreForTeamInSchedule(requestDS);
                }
                else
                {
                    requestDS.Score[0].ScheduleID = scheduleID;
                    requestDS.Score[0].ParticipantID = teamOrParticipantID;
